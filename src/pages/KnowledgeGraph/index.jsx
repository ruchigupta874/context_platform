...
export default function KnowledgeGraph() {
    ...
    return {
      properties:
        fixture?.properties ?? [
          ...
          { id: 'p3', key: 'ex:sourceRun', value: BUILT_BY_RUN },
        ],
  ...
  return (
    <>
      <TopBar
        crumbs={[{ label: 'Cust360Auto' }, { label: 'Knowledge graph' }]}
        note={`${GRAPH_TOTALS.nodes} nodes · ${GRAPH_TOTALS.edges} edges`}
        actions={
          <>
        ...
        <div className={styles.canvasColumn}>
          <div className={styles.canvasBar}>
            ...
            <span className={styles.canvasCount}>
              {visibleNodes.length} of {GRAPH_TOTALS.nodes} shown
            </span>
            ...
            <div>
              ...
              <div className={styles.provenance}>
                ...
                <div className={styles.provRow}>
                  ...
                  <span className={styles.provValue}>{BUILT_BY_RUN}</span>
                </div>
              </div>
            </div>
          </div>
